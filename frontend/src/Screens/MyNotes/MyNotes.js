...
const MyNotes = () => {
    ...
    return (<MainScreen title={"Welcome Back Pratyush Mahapatra"}>
    <Link to='/createnote'>
    <Button className="ml-3 mb-1 w-56 text-white">Create New Note</Button>
    </Link>
    {notes.map((note,index) => { return(<div className="w-full p-4">
        
        <div className="p-5 rounded-xl shadow-md bg-white"><span className="text-6xl">❝</span>
        <div className='mb-5 '><Disclosure>
          {({ open }) => (
            <>
            ...
            <span class="bg-yellow-500 text-yellow-50  py-1 px-2 rounded text-xs font-bold ml-1">Category</span>
            <hr className="my-4 " />
            ...
            <div className="flex flex-wrap items-center">
                <div className=' flex space-x-20  lg:flex-grow lg:w-full justify-between'>
                    ...
                    <div className=' flex space-x-5'>
                        <a href={`/note/${note._id}`} ><Buttonalt className="items-center w-10 h-10  rounded-xl text-sm bg-green-600 hover:bg-green-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="h-6 w-6" viewBox="0 0 24 24">
                        ...
                        <Buttonalt onClick={()=> deleteHandler(note._id)} className="items-center w-10 h-10 rounded-xl text-sm bg-red-600 hover-bg-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="h-6 w-6" viewBox="0 0 24 24">
