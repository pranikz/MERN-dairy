...
const Card = (props) => {
    return (
        ...
        <div className="p-8 rounded-xl shadow-md bg-white"><span className="text-6xl">❝</span>
            ...
            <div className="flex flex-wrap items-center">
                <div className=' flex space-x-20  lg:flex-grow lg:w-full justify-between'>
                    ...
                    <div className=' flex space-x-5'>
                        <Buttonalt className="items-center w-10 h-10  rounded-xl text-sm bg-green-600 hover:bg-green-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="h-6 w-6" viewBox="0 0 24 24">
                        ...
                        <Buttonalt className="items-center w-10 h-10 rounded-xl text-sm bg-red-600 hover-bg-red-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="h-6 w-6" viewBox="0 0 24 24">
